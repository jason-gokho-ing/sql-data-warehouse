...
BEGIN
    ...
    BEGIN TRY 
        ...
        FROM 'C:\SQL Server Management Studio 21\sql-data-warehouse\datasets\source_crm\crm_cust_info.csv'
        WITH (
            FIRSTROW = 2,
            FIELDTERMINATOR = ',',
            TABLOCK
        ...
        FROM 'C:\SQL Server Management Studio 21\sql-data-warehouse\datasets\source_crm\crm_prd_info.csv'
        WITH (
            FIRSTROW = 2,
            FIELDTERMINATOR = ',',
            TABLOCK
        ...
        FROM 'C:\SQL Server Management Studio 21\sql-data-warehouse\datasets\source_crm\crm_sales_details.csv'
        WITH (
            FIRSTROW = 2,
            FIELDTERMINATOR = ',',
            TABLOCK
        ...
        FROM 'C:\SQL Server Management Studio 21\sql-data-warehouse\datasets\source_erp\erp_cust_info.csv'
        WITH (
            FIRSTROW = 2,
            FIELDTERMINATOR = ',',
            TABLOCK
        ...
        FROM 'C:\SQL Server Management Studio 21\sql-data-warehouse\datasets\source_erp\erp_locations.csv'
        WITH (  
            FIRSTROW = 2,
            FIELDTERMINATOR = ',',
            TABLOCK
        ...
        FROM 'C:\SQL Server Management Studio 21\sql-data-warehouse\datasets\source_erp\erp_prd_cat.csv'
        WITH (
            FIRSTROW = 2,
            FIELDTERMINATOR = ',',
            TABLOCK
