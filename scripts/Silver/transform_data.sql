...
-- (Whitespace and formatting adjusted for readability; existing comments and logic preserved)

CREATE OR ALTER PROCEDURE silver.silver_load_table_data
AS
BEGIN
    -- Timing variables for the whole batch and per-table measurements
    ...
    BEGIN TRY
        ...
        SELECT
            ...
            SUBSTRING(prd_key, 7, LEN(prd_key))          AS prd_key,          -- Use substring function to isolate portion of prd_key to match other table
            prd_name,
